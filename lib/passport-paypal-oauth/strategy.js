...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://www.sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/authorize';
  options.tokenURL = options.tokenURL || 'https://api.sandbox.paypal.com/v1/identity/openidconnect/tokenservice';
  options.profileURL = options.profileURL || 'https://api.sandbox.paypal.com/v1/identity/openidconnect/userinfo/?schema=openid';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this._oauth2.getProtectedResource(this.profileURL, accessToken, function (err, body, res) {
